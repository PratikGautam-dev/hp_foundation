    ...
    const onSubmit = async (data: DonationFormData) => {
        ...
        try {
            ...
            const options = {
                ...
                description: `Donation for ${CAUSES.find(c => c.id === data.cause)?.label}`,
                ...
                handler: async function (response: any) {
                    ...
                    try {
                        ...
                        if (verifyRes.ok) {
                            ...
                            window.location.href = `/donate/thank-you?txn=${response.razorpay_payment_id}&amount=${data.amount}&cause=${data.cause}`;
                        } else {
